...
class TaskSubmissionsControllerTest < ActionController::TestCase
  ...
  test "should create task_submission" do
    assert_difference('TaskSubmission.count') do
      post :create, task_submission: { comment: @task_submission.comment, state: @task_submission.state, task_id: @task_submission.task_id, user_id: @task_submission.user_id }
    end
  ...
  test "should update task_submission" do
    patch :update, id: @task_submission, task_submission: { comment: @task_submission.comment, state: @task_submission.state, task_id: @task_submission.task_id, user_id: @task_submission.user_id }
    assert_redirected_to task_submission_path(assigns(:task_submission))
  end
